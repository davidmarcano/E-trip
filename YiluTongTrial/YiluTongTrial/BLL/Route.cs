...
namespace YiluTongTrial.BLL
{
    public static class Route
    {
        ...
        public static YiluTongTrial.Models.Route GetRouteByUserId(string userId)
        {
            DBDataContext db = new DBDataContext();
        ...
        public static YiluTongTrial.Models.Route GetRouteByNumber(string routeNumber)
        {
            DBDataContext db = new DBDataContext();
        ...
        public static List<YiluTongTrial.Models.RouteMember> GetRouteMembersByNumber(string routeNumber)
        {
            DBDataContext db = new DBDataContext();
        ...
        public static CreateRouteResponse CreateRoute(string FromLongitude, string FormLatitude, string ToLongitude, string ToLatitude, string UserId, string UserName, string UserPicture)
        {
            ...
            var route = new YiluTongTrial.Models.Route()
            {
            ...
            var routeMember = new YiluTongTrial.Models.RouteMember()
            {
