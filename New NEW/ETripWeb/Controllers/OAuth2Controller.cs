    ...
    public class OAuth2Controller : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var url = OAuth.GetAuthorizeUrl(appId,
                "http://123.138.75.236/OAuth2/IndexCallback", "JeffreySu", OAuthScope.snsapi_userinfo);
            ViewData["Url"] = url;
        ...
        public ActionResult JoinWayCallback(string code, string state)
        {
            ...
            if (routeModel != null)
            {
                return View("~/Views/Home/Endtrip.cshtml", routeModel);
            }
            else
            {
        ...
        public ActionResult JoinWay(string userId, string number)
        {
            ...
            var url = OAuth.GetAuthorizeUrl(appId,
                "http://123.138.75.236/OAuth2/JoinWayCallback", "JeffreySu", OAuthScope.snsapi_userinfo);
            ViewData["Url"] = url;
            Response.Redirect(url);
            return View();
        }
