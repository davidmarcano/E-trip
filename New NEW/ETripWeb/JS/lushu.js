...
"visible"
    }; c.object.extend(g.prototype, { _addMarker: function () { if (this._marker) { this.stop(); this._map.removeOverlay(this._marker); clearTimeout(this._timeoutFlag) } this._overlay && this._map.removeOverlay(this._overlay); var a = new BMap.Marker(this._path[0]); this._opts.icon && a.setIcon(this._opts.icon); this._map.addOverlay(a); a.setAnimation(BMAP_ANIMATION_DROP); this._marker = a }, _addInfoWin: function () {
